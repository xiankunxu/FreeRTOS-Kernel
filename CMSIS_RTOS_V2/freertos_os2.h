...
*/
  ...
  */
  ...
  /*
    CMSIS-RTOS2 defines 10 different priorities (see osPriority_t) and portable CMSIS-RTOS2
    implementation should implement the same number of priorities.
    Set #define configMAX_PRIORITIES 10 to fix this error.
  */
  ...
  */
  ...
  /*
    ...
    Set #define configKERNEL_PROVIDED_STATIC_MEMORY 1 to fix this error.
  */
  #error "Definition configKERNEL_PROVIDED_STATIC_MEMORY must equal 1 to implement CMSIS-RTOS2 API."
#endif
